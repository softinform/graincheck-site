...
| File | What's on it |
|---|---|
| `01-hero-analytics.png` | Calculator result: full economics of a 23.5 t wheat batch — weight loss 0.787 t (3.35%), credited weight 22.713 t, services cost 13 550.28 ₴, services share 43.62% of revenue, net revenue 17 516.72 ₴, cost-basis price 1 964.39 ₴/t. |
...
- `https://graincheck.app/promo/01-hero-analytics.png`
